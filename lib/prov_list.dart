...
class ProvList extends StatelessWidget {
        ...
        children: <Widget>[
          ListTile(
            ...
            title: Text(data.firstname +
                ...
                ". " +
                data.lastname),
            subtitle: __parseSubtitle(
                context, data.contact, data.latitude, data.longitude),
          ),
          Padding(
                  ...
                  if (snap.hasData) {
                    ...
                    return Row(
                      ...
                      return Icon(
                        ...
                        color:
                            index < nData.rating ? Colors.amber : Colors.black,
                      );
                    }));
                  } else {
                    return Row(
  ...
  __parseSubtitle(context, String contact, double lat, double long) {
    Future<List<Placemark>> placemark =
        Geolocator().placemarkFromCoordinates(lat, long);
